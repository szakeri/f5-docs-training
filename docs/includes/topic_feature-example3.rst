...
The F5® LBaaSv2 agent and driver can manage BIG-IP® device service clusters, providing :term:`high availability`, :term:`mirroring`, and :term:`failover` services within your OpenStack cloud.
...
Prerequisites
-------------
.. these can be copied from the prerequisites file
